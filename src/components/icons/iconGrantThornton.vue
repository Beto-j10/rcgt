<template>
    <svg
        ...
        width="208.9px"
        height="38.838px"
        viewBox="0 0 208.9 38.838"
        enable-background="new 0 0 208.9 38.838"
        xml:space="preserve"
    >
        <g>
            <path
                d="M81.043,27.482c-1.912,0-2.63-0.837-2.63-2.182c0-1.554,0.867-2.361,3.138-2.361h2.989v0.896
        ...
        <g>
            <defs>
                <path
                    id="SVGID_1_"
                    d="M9.881,2.509c-0.134,0.075-0.27,0.147-0.404,0.227C0.396,8.148-2.66,19.803,2.51,28.959
            ...
            <linearGradient
                ...
                x2="-80.122"
                y2="527.9985"
                gradientTransform="matrix(-27.8409 1.9468 1.9468 27.8409 -3258.8481 -14527.6934)"
            >
                <stop offset="0" style="stop-color:#4F2683" />
                <stop offset="0.1209" style="stop-color:#4F2683" />
                <stop offset="0.2262" style="stop-color:#5D378D" />
                <stop offset="0.5149" style="stop-color:#7E62A5" />
                <stop offset="0.7404" style="stop-color:#927DB3" />
            ...
            <polygon
                ...
                fill="url(#SVGID_3_)"
                points="32.101,28.826 -2.5,31.246 -4.562,1.753 30.039,-0.667 	"
            />
        </g>
        <g>
            <defs>
                <path
                    id="SVGID_4_"
                    d="M2.51,28.957c0.075,0.135,0.147,0.269,0.226,0.404c5.412,9.081,17.067,12.137,26.224,6.967
            ...
            <linearGradient
                ...
                x2="-80.1167"
                y2="527.9673"
                gradientTransform="matrix(1.9468 27.8411 27.8411 -1.9468 -14528.2334 3297.5532)"
            >
                <stop offset="0" style="stop-color:#4F2683" />
                <stop offset="0.1209" style="stop-color:#4F2683" />
                <stop offset="0.2262" style="stop-color:#5D378D" />
            ...
            <polygon
                ...
                fill="url(#SVGID_6_)"
                points="28.815,9.168 31.065,41.351 -0.604,43.565 -2.854,11.382 	"
            />
        </g>
        <g>
            <defs>
                <path
                    id="SVGID_7_"
                    d="M19.42,26.914c-3.058-0.971-5.489-3.249-7.126-6.486c-0.218-0.434-0.332-1.084-0.214-1.468
            ...
            <linearGradient
                ...
                x2="-80.1268"
                y2="527.9321"
                gradientTransform="matrix(27.8407 -1.9468 -1.9468 -27.8407 3297.7441 14566.0078)"
            >
                <stop offset="0" style="stop-color:#4F2683" />
                <stop offset="0.1209" style="stop-color:#4F2683" />
                <stop offset="0.2262" style="stop-color:#5D378D" />
            ...
            <polygon
                ...
                fill="url(#SVGID_9_)"
                points="5.9,10.024 41.334,7.546 43.595,39.882 8.162,42.36 	"
            />
        </g>
        <g>
            <defs>
                <path
                    id="SVGID_10_"
                    d="M9.879,2.51c7.056-3.704,20.961,4.568,17.037,16.908c-0.972,3.058-3.251,5.488-6.488,7.125
            ...
            <linearGradient
                ...
                x2="-80.1196"
                y2="527.9478"
                gradientTransform="matrix(-1.9468 -27.8409 -27.8409 1.9468 14566.4766 -3258.7744)"
            >
                <stop offset="0" style="stop-color:#4F2683" />
                <stop offset="0.1209" style="stop-color:#4F2683" />
                <stop offset="0.2262" style="stop-color:#5D378D" />
            ...
            <polygon
                ...
                fill="url(#SVGID_12_)"
                points="10.025,32.936 7.65,-1.038 39.882,-3.292 42.258,30.682 	"
            />
        </g>
    </svg>
</template>